...
Самая интересная задача — разработка веб-компилятора с безопасным исполнением пользовательского кода. Пришлось продумывать песочницу для изоляции процессов, лимиты на время выполнения, санитайзинг ввода и защиту от DOS-атак. Особенно увлекательно было балансировать между безопасностью и удобством использования, чтобы система оставалась и надёжной, и функциональной.

Самый большой факап — случайно залил тестовые данные в продовую БД во время отладки скрипта миграции. Хорошо, что быстро заметил и откатил изменения, но с тех пор всегда ставлю дополнительные проверки окружения и делаю бэкапы перед рискованными операциями.

Ожидания от буткемпа — мне особенно интересна облачная инфраструктура, поэтому хочу глубже погрузиться в эту сферу. Ожидаю, что работа в команде профессионалов из Cloud.ru даст мощный толчок для роста — как в hard skills, так и в понимании масштабируемых систем.
